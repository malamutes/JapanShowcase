...
const EntertainmentData: { [key: string]: EntertainmentDataType } = {
    AOT: {
        front: '/Public/Images/EntertainmentImages/AOTFront.jpg',
        back: '/Public/Images/EntertainmentImages/AOTBack.jpg',
    ...
    FMAB: {
        front: '/Public/Images/EntertainmentImages/FMABFront.jpg',
        back: '/Public/Images/EntertainmentImages/FMABBack.jpg',
    ...
    Naruto: {
        front: '/Public/Images/EntertainmentImages/NarutoFront.jpg',
        back: '/Public/Images/EntertainmentImages/NarutoBack.jpg',
        fullName: 'Naruto - ナルト',
    ...
    Monster: {
        front: '/Public/Images/EntertainmentImages/MonsterFront.jpg',
        back: '/Public/Images/EntertainmentImages/MonsterBack.jpg',
    ...
    DeathNote: {
        front: '/Public/Images/EntertainmentImages/DeathNoteFront.jpg',
        back: '/Public/Images/EntertainmentImages/DeathNoteBack.jpg',

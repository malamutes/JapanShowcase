...
const PlaceData: { [key: string]: PlaceDescription } = {
    ...
    Sapporo: {
        title: "Sapporo - さっぽろ",
        description: `The capital of Hokkaido, Sapporo is known for ists beer, skiing, and annual Sapporo Snow Festival featuring ice sculptures and winter activities.`,
